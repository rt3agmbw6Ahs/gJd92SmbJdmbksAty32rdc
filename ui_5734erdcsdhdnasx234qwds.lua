...
local library = {
    version = "1",
    title = title or "deju script " .. tostring(math.random(1,366)),
    fps = 0,
    rank = "private"
}
...
function library:Introduction()
    ...
    text.Text = "<3 dejubos on discord"
